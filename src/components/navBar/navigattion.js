...
function NavBarr({ data }) {
  ...
  return (
    ...
    >
      <nav className="  bg-[#4b0c29] relative">
            ...
            <div>
              ...
              <ul className="">
                ...
                >
                  ...
                  <div onClick={() => data.setNavBarToggle(!data.navBarToggle)}>
                    <RiCloseFill
              ...
              <div className="grid grid-cols-2 list-none mt-6 px-6">
                {ADdata.filter(
                  ...
                  <li key={key} className="mt-2 text-[.75rem] text-[#ffffff]">
                    {item.name}
                  </li>
                ))}
              </div>
        ...
        <div className="pt-[9px] pb-[25px] bg-[#b86799] fixed bottom-0 left-0 w-full">
          <h3 className="text-xs text-center text-[#ffffff]">
            REGISTERED # 1234567891
          </h3>
        </div>
      </nav>
    </div>
